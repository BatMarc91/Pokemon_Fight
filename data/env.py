# Url per a la API de pokemon
url = "https://pokeapi.co/api/v2"

# Defineixo els noms del meu equip pokemon
    # Puc fer 3 nivells de dificultat (més endavant)
marc_beginner = ["Luxray", "Typhlosion", "Treecko", "Poliwrath", "Furret", "Hypno"]

marc_mid = ["Gyarados", "Electivire", "Heracross", "Gardevoir", "Sneasel", "Alakazam"]
